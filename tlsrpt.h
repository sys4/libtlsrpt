...
/* TLSRPT_VERSION_PRERELEASE is only defined for pre-release versions, use #ifdef to query */
#define TLSRPT_VERSION_PRERELEASE "rc2"

#define _TLSRPT_VERSION_XSTR(s) _TLSRPT_VERSION_STR(s)
#define _TLSRPT_VERSION_STR(s) #s

#ifdef TLSRPT_VERSION_PRERELEASE
